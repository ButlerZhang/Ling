...
class ScoreBoard():
    ...
    def prep_score(self):
        """将当前得分转换为渲染的图像"""
        rounded_score = int(round(self.stats.score, -1)) #取为10的倍数
    ...
    def prep_high_score(self):
        ...
        self.high_score_image = self.font.render(high_str, True, self.text_color, self.ai_settings.background_color)
